...
import deveone.solomatin.AdjMatrixWeightedGraph;
...
public class Canvas extends JComponent {
    ...
    private final AdjMatrixWeightedGraph graph = new AdjMatrixWeightedGraph(); //Матрица смежности вершин
    ...
    private void handleAddModeClick(Point clickPoint) {
        ...
        if (objectMode == ObjectModes.VERTEX) { //Режим вершин
            ...
            } else if (!linesBuffer[0].equals(v)){
                linesBuffer[1] = v;
